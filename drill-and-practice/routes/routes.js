...
router
  .get("/auth/register", registrationController.showRegistrationForm)
  .post("/auth/register", registrationController.postRegistrationForm);
router.get(
  "/auth/register/success",
  registrationController.showRegistrationSuccess,
);
...
//topics routing
router
  .get("/topics", topicsController.showTopics)
...
router.post(
  ...
  questionsController.postDeleteQuestionForm,
);
...
router.post(
  ...
  questionAOController.postAddQuestionAOForm,
);
router.post(
  "/topics/:id/questions/:qID/options/:oID/delete",
  questionAOController.postDeleteQuestionAOForm,
);
//quiz routing
